...
A complete model of lubricant film formation in ball bearings has not yet been established and the physicochemical behaviour of lubricants under the high speed, high pressure conditions in bearings remains incompletely characterised \cite{cen_ehl_2021} \cite{dai_situ_2024} \cite{li_lubrication_2026}. Instead, multiple theoretical models exist which seek to estimate the lubrication film thickness in running ball bearings and the sufficiency thereof under specific operating conditions and with different lubricants.
