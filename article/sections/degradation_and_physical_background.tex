...
\kappa = \frac{\nu}{\nu_{1}},
\end{equation}
where $\nu$ is the kinematic viscosity of the applied lubricant under the operating conditions and $\nu_{1}$ is the reference kinematic viscosity calculated from the ISO 281 standard for the bearing diameter and rotational speed \cite{jakobsen_detecting_2023}. Interpretation guidelines are \todo{Find citation for $\kappa$ thresholds (ISO 281 or SKF/FAG catalogue)}:
\begin{itemize}
