...
Lubrication films formed in ball bearings under operation are generally classified into three regimes depending on the physical contact between balls and raceways and how the bearing load is distributed \cite{stachowiak_engineering_2014}:
\begin{itemize}
