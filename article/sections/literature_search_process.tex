...
\hline
English-language peer-reviewed journal papers or conference proceedings & Non-peer-reviewed sources (technical reports, white papers, patents) \\
\hline
\end{tabularx}
\caption{Inclusion and exclusion criteria for the systematic literature search.}
\label{tab:criteria}
\end{table}
\todo[inline]{Check inclusion criteria: (1) Are slew bearings relevant? (2) Verify that non-peer-reviewed sources are excluded.}
