...
\hline
Study concerns lubrication condition in rolling element bearings (including ball bearings, cylindrical roller bearings, tapered roller bearings, or slew bearings\todo{Check whether all of these are relevant. Slew bearings??}) & Study concerns journal bearings, thrust washers, or non-bearing lubricated contacts exclusively \\
\hline
...
\hline
English-language peer-reviewed journal papers or conference proceedings & Non-peer-reviewed sources (technical reports, white papers, patents)\todo{Check that this is true} \\
\hline
\end{tabularx}
