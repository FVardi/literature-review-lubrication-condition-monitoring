...
\textbf{Future direction:} Controlled studies systematically varying grease degradation state (base-oil bleed-out, aging time, thickener degradation, contamination type and concentration) while simultaneously measuring passive sensor signals and reference quantities (film thickness by electrical or optical methods, grease rheological properties by in-situ rheometry, or friction measurements for Stribeck curve data) are needed. The specific contribution of thickener structure to AE and vibration signals -- separate from base-oil film-forming effects -- has not been isolated in the reviewed literature.
