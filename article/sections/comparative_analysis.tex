...
\hline
Vibration & Time-domain (RMS, kurtosis) & Moderate \cite{jakobsen_vibration_2021,xu_vibration-based_2024} & Low--Moderate \cite{jakobsen_vibration_2021} & \\
\hline
Vibration & MED + envelope & High \cite{xu_vibration-based_2024} & & \\
\hline
Vibration & Spectral kurtosis + $\kappa$ regression & Moderate--High \cite{jakobsen_vibration_2021} & Moderate \cite{jakobsen_vibration_2021} & \\
\hline
...
\hline
AE & Octave filter bank ($P_5$) & High \cite{renhart_monitoring_2021} & & High \cite{renhart_monitoring_2021} \\
\hline
AE & Multi-band hit-rate + WPI & & & High (abrasive only) \cite{delft_university_of_technology_tu_delft_influence_2024} \\
\hline
Passive ultrasound & Threshold (dB) & Moderate \cite{lineham_ultrasonic_2008} & & \\
\hline
Passive ultrasound & Spectral kurtosis + $\kappa$ regression & Moderate--High \cite{jakobsen_detecting_2023} & & \\
\hline
Thermal & Time-domain (trend) & Moderate (slow response) \cite{moussa_passive_2017} & & \\
\hline
Active ultrasonic & Spring-layer model & High (film thickness) \cite{chen_evaluation_2023,dwyer-joyce_measurement_2003} & High (film thickness) \cite{chen_evaluation_2023} & \\
\hline
Electrical & Circuit model & High (film thickness) \cite{cen_ehl_2021,becker-dombrowsky_electrical_2024} & & \\
\hline
Magnetic / inductive & Mode decomp.\ + pulse & & & High (ferrous debris) \cite{yu_novel_2021} \\
\hline
\end{tabularx}
...
\hline
AE & None & Flat surface, direct structural path to bearing bore; avoid joints and material changes; bond or clamp required for high-freq.\ coupling & $>$500\,kHz & Partial (features only) & Baseline measurement under known lubrication condition \cite{lineham_ultrasonic_2008}; labelled data for ML \\
\hline
...
\hline
Vibration & $\kappa$ regression (LASSO, NN) & Research & \cite{jakobsen_vibration_2021} \\
\hline
