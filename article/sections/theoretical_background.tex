...
\label{sec:theory}
\todo{Make sure the section covers regimes, degradation, starvation, and contamination}
...
\hline
Asperity-to-asperity contact and micro-fracture under insufficient film thickness & Transient elastic stress waves & Source: >20\,MHz; at sensor: 20--500\,kHz (path-limited) & AE sensors; passive ultrasound ($>$20\,kHz). High-frequency content is attenuated by housing interfaces; usable bandwidth is geometry-dependent. \\
\hline
...
\hline
Viscous shear and frictional energy dissipation & Heat generation; bearing temperature rise & Thermal response bandwidth of sensor DC--10\,Hz (thermally diffusion-limited) & Thermocouples; IR thermography. No acoustic path loss; temporal resolution limited to seconds--minutes by thermal diffusion. \\
\hline
Change in dielectric properties of lubricant film (film thickness, viscosity, debris) & Change in capacitance, impedance, or resistance & DC--10\,MHz (excitation) & Electrical capacitance/impedance sensors (active). Dependent on electrical
signal path, water content, temperature, and fouling; no structural wave propagation or path attenuation.  \\
\hline
...
\hline
Ferromagnetic wear debris in lubricant flow & Perturbation of magnetic flux or inductance; eddy currents for non-ferromagnetic materials & DC--kHz (debris transit) & Inductive/magnetic debris sensors. Signal is in lubricant flow path; structural propagation not involved. \\
\hline
