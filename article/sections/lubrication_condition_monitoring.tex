...
% Regions
\fill[region, black!4] (2.35,-1.15) rectangle (14.70,1.85);
\node[tag] at (2.55,1.67) {LCM + MAINTENANCE DECISION};
\fill[region, black!9] (2.65,-0.90) rectangle (11.65,1.35);
\node[tag] at (2.85,1.17) {LCM};
